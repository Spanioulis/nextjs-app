...
export default function Home() {
   return (
      <div>
         <Header>
            <div className="mb-[-60px] flex h-screen justify-center bg-neuronal-grid bg-cover bg-center bg-no-repeat pt-[100px] text-white">
               <main className="relative  w-2/3 self-start rounded-sm bg-black/30 p-6 leading-relaxed">
